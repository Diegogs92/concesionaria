...
// La clave anónima es pública por diseño: RLS bloquea todas las tablas para
// `anon` y solo la vista `autos_publicos` tiene GRANT SELECT
// (ver supabase/migrations/20260610130000_enable_rls_and_public_view.sql).
